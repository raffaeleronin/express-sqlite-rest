...
app.route('/books')
    .get(function (req, res, next) {
        ...
        let tracker = uuidv4();
        database.emit('GET','books',tracker);
    ...
    .post(function (req, res, next) {
        ...
        console.log(req.originalUrl + ' -- ' + req.method + ' called');
        let tracker = uuidv4();
        database.emit('POST','books',tracker, (req.body));
...
app.route('/books/:id')
    .get(function (req, res, next) {
        console.log(req.originalUrl + ' -- ' + req.method + ' called');
        let tracker = uuidv4();
        database.emit('GET','books',tracker, req.params.id);
        database.on('GET ready', (_tracker, data)=>{
            if(tracker===_tracker){ console.log(data); res.json(data); }
        }); 
    })
    ...
    .put(function(req,res,next){
        ...
        console.log(req.originalUrl + ' -- ' + req.method + ' called');
        let tracker = uuidv4();
        database.emit('PUT','books',tracker,req.params.id, (req.body));
    ...
    .delete(function(req,res,next){
        ...
        console.log(req.originalUrl + ' -- ' + req.method + ' called');
        let tracker = uuidv4();
        database.emit('DELETE','books',tracker, req.params.id, (req.body));
